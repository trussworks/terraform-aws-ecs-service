...
| <a name="input_manage_ecs_security_group"></a> [manage\_ecs\_security\_group](#manage\_ecs\_security\_group) | Enable creation and management of the ECS security group and rules | `bool` | `true` | no |
